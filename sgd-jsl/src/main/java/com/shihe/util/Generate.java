...
public class Generate {
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"sgd_stock_history"}); // 需要生成的表
...
//         strategy.setSuperEntityColumns(new String[] { "test_id", "age" });
        // 自定义 mapper 父类
        // strategy.setSuperMapperClass("NoticeMapper");
        // 自定义 service 父类
        // strategy.setSuperServiceClass("NoticeService");
        // 自定义 service 实现类父类
        //  strategy.setSuperServiceImplClass("NoticeServiceImpl");
        // 自定义 controller 父类
        // strategy.setSuperControllerClass("NoticeController");
